...
public class GuessFragment extends Fragment {
    ...
    private ImageButton playGuessButton;
    ...
    public void onViewCreated(View view, Bundle savedInstanceState) {
        ...
        playGuessButton = view.findViewById(R.id.btn_play_guess);
...
//        });
        ...
        playGuessButton.setOnTouchListener((v, event) -> {
            switch (event.getAction()) {
                ...
                case MotionEvent.ACTION_CANCEL:
                    v.animate().scaleX(1f).scaleY(1f).translationZ(0f).setDuration(100).start(); // ← 0f not 12f
        ...
        view.findViewById(R.id.button_pronounce_fragment).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                goToFragment(PronounceFragment.class);
            }
        });
...
//        if (pulseSet != null) pulseSet.cancel();
    ...
    private void startPlayButtonAnimation() {
        ...
        ObjectAnimator scaleX = ObjectAnimator.ofFloat(playGuessButton, "scaleX", 1f, 1.1f, 1f);
        scaleX.setRepeatCount(ObjectAnimator.INFINITE);

        ObjectAnimator scaleY = ObjectAnimator.ofFloat(playGuessButton, "scaleY", 1f, 1.1f, 1f);
        ...
        ObjectAnimator elevation = ObjectAnimator.ofFloat(playGuessButton, "translationZ", 4f, 20f, 4f);
